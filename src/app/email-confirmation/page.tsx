...
export default function EmailConfirmationPage() {
  ...
  return (
    <main className="fixed top-0 left-0 w-screen h-screen flex items-center justify-center bg-white/10 backdrop-blur-sm z-[999]">
      <div className="text-center p-10 bg-white/10 backdrop-blur-sm border border-white/30 shadow-lg rounded-4xl max-w-md w-full">
        {status === "verifying" && (
          <>
        ...
        {status === "success" && (
          <>
            <div className="w-20 h-20 mx-auto bg-green-500/20 backdrop-blur-sm border border-white/30 shadow-lg rounded-full flex items-center justify-center">
        ...
        {status === "error" && (
          <>
            <div className="w-20 h-20 mx-auto bg-red-500/20 backdrop-blur-sm border border-white/30 shadow-lg rounded-full flex items-center justify-center">
            ...
            <div className="mt-6 border-t border-white/20 pt-6 space-y-4">
              ...
              <input
                ...
                className="text-white/80 w-full px-3 py-2 bg-white/10 backdrop-blur-sm border border-white/30 shadow-lg rounded-4xl focus:ring-2 focus:ring-white/30 focus:outline-none"
              ...
              >
                {resendLoading ? t("resend.buttonLoading") : t("resend.button")}
              </button>
            </div>
          </>
        )}
