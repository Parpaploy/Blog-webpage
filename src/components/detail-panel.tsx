    ...
    <AnimatePresence>
      {isToggle && (
        <motion.div
          ...
          className="absolute md:top-10 top-7 right-0 w-60 h-fit bg-black/50 backdrop-blur-sm backdrop-brightness-200 border border-white/30 shadow-md rounded-lg overflow-hidden z-50"
