          ...
          <>
            ...
            <button
              ...
              className={`cursor-pointer ${
                onCreateAnother ? "mt-3" : "mt-6"
              } text-white/80 w-full px-3 py-2 hover:bg-white/20 hover:text-white/90 bg-white/10 border border-white/30 shadow-md rounded-4xl transition-all`}
            >
